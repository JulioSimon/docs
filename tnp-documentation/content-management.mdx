...
description: 'Manage posts, pages, and content in the Tonga National Portal'
icon: 'file-lines'
---
...
<CardGroup cols={2}>
  <Card title="Chronological Organization" icon="calendar">
    Posts are displayed in reverse chronological order (newest first) by default
  </Card>
  <Card title="Categorization and Tagging" icon="tags">
    Posts can be organized using hierarchical categories and non-hierarchical tags
  </Card>
  <Card title="Archives" icon="box-archive">
    Automatically organized into date-based archives (yearly, monthly, daily)
  </Card>
  <Card title="RSS Feed Integration" icon="rss">
    Automatically included in the site's RSS feed for syndication
  </Card>
  <Card title="Comments" icon="comments">
    Built-in commenting system for reader engagement
  </Card>
  <Card title="Permalinks" icon="link">
    Customizable URL structures for better SEO and readability
  </Card>
  <Card title="Featured Images" icon="image">
    Visual representation of the post content
  </Card>
  <Card title="Excerpts" icon="quote-left">
    Short summaries that can be displayed in listings
  </Card>
</CardGroup>
...
<Steps>
  <Step title="Accessing the Posts Section">
  ...
  <Step title="Basic Post Elements">
  ...
  <Step title="Post Settings in the Sidebar">
  ...
  <Step title="Post-Publication Actions">
  ...
  <Tab title="Categories">
    <AccordionGroup>
      <Accordion title="Definition">
        Hierarchical taxonomy for broad content classification
      </Accordion>
    ...
    <Frame caption="Adding Categories to Posts">
      ![Categories panel in the content editor showing selection options](./../images/tnp/contentManagement16.png)
    </Frame>
    
    <Note>
      In the post editor, locate the Categories panel in the sidebar to select existing categories by checking the boxes or add new categories directly using the "Add New Category" link. You can also set parent-child relationships for hierarchical organization.
    </Note>
  </Tab>
  <Tab title="Tags">
    <AccordionGroup>
      <Accordion title="Definition">
        Non-hierarchical taxonomy for specific content keywords
      </Accordion>
      <Accordion title="Characteristics">
    ...
    <Frame caption="Adding Tags to Posts">
      ![Tags field at content editor](./../images/tnp/contentManagement17.png)
    </Frame>
    
    <Note>
      In the post editor, locate the Tags panel in the sidebar to enter tags separated by commas. You can select from previously used tags as you type and add as many tags as relevant to the content.
    </Note>
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="Hierarchical Structure" icon="sitemap">
    Pages can have parent-child relationships, creating nested navigation
  </Card>
  <Card title="Static Content" icon="file-lines">
    Designed for information that doesn't change frequently
  </Card>
  <Card title="No Categorization or Tagging" icon="ban">
    Pages don't use the standard WordPress taxonomy system
  </Card>
  <Card title="No Date Organization" icon="calendar-xmark">
    Pages aren't organized chronologically or displayed in date archives
  </Card>
  <Card title="Custom Templates" icon="layer-group">
    Many themes offer page-specific templates for different layouts
  </Card>
  <Card title="Menu Integration" icon="bars">
    Commonly used as primary navigation items
  </Card>
  <Card title="No RSS Inclusion" icon="rss">
    Pages aren't included in the site's RSS feed by default
  </Card>
  <Card title="Permalinks" icon="link">
    Typically have simpler URL structures than posts
  </Card>
</CardGroup>
...
<Steps>
  <Step title="Accessing the Pages Section">
    - Log in to the WordPress admin dashboard
  ...
  <Step title="Basic Page Elements">
    - **Title**: Enter a descriptive title at the top of the editor
    - **Content**: Add the main content using the block editor (Gutenberg) or Bricks editor
  ...
  <Step title="Page Settings in the Sidebar">
    - **Status & Visibility**: Set publication status, visibility, and scheduling options
...
<Steps>
  <Step title="Understanding the Gutenberg Interface">
  ...
  <Step title="Working with Blocks">
  ...
  <Step title="Advanced Block Features">
  ...
  <Step title="Previewing and Publishing">
...
<Steps>
  <Step title="Accessing Bricks Editor for Posts and Pages">
  ...
  <Step title="Understanding the Bricks Interface">
  ...
  <Step title="Structuring Content">
  ...
  <Step title="Dynamic Data Integration">
...
<Steps>
  <Step title="Creating a New Multilingual Post or Page">
  ...
  <Step title="Translating Existing Content">
  ...
  <Step title="Translation Editor Interface">
  ...
  <Step title="Managing Content Translation Status">
  ...
  <Step title="Translating Post Taxonomies">
...
The FS Poster is a powerful WordPress plugin that enables automatic sharing of posts or pages to multiple social media platforms. Below is a detailed guide on managing social sharing of content using the FS Poster plugin:

<Steps>
  <Step title="Setting Up FS Poster">
  ...
  <Step title="Configuring Default Sharing Settings">
  ...
  <Step title="Sharing Options in Content Editor">
  ...
  <Step title="Customizing Share Content">
  ...
  <Step title="Monitoring Share Performance">
